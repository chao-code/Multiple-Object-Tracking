...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/best2.pt', help='weights path')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640], help='image size')  # height, width
    parser.add_argument('--batch-size', type=int, default=1, help='batch size')
    parser.add_argument('--max-obj', type=int, default=1000, help='topk')
    parser.add_argument('--iou-thres', type=float, default=0.55, help='nms iou threshold')
    parser.add_argument('--score-thres', type=float, default=0.1, help='nms score threshold')
